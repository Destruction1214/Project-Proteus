return {
	Era_1 = {
		...
		{
			{"Faux_Stormtrooper_Company", 5},
			{"Imperial_Stormtrooper_Company", 5},
			{"Acclamator_I_Supercruiser", 3},
			{"Acclamator_I_Assault", 3},
			{"Imperial_TX130S_Company", 3},
			{"Strike_Interdictor", 2},
		},
		{
			{"Victory_I_Star_Destroyer", 2},
			{"Acclamator_I_Support", 3},
			{"Venator_8X", 2},
